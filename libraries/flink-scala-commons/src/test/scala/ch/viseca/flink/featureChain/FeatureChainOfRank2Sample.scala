...
object FeatureChainOfRank2Sample {
...
//    internationalAddressFeature.print()
    ...
    printExecutionPlan(env, stream, countries, countryInput, personCountryFeature, withId, personFeature, fullNameInput, fullNameFeature, addressInput, addressCountryInput, localAddressFeature, internationalAddressFeature, collectedPersonFeatures)
